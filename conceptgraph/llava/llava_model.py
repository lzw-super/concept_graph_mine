...
class LLaVaChat(object):
    def __init__(self, model_path, conv_mode="multimodal", num_gpus=1,bits = 4):
        ...
        self.model = LlavaLlamaForCausalLMTweaked.from_pretrained(
            self.model_path, torch_dtype=torch.float16, low_cpu_mem_usage=True,quantization_config = quantize_config,trust_remote_code=True,device_map="auto", **kwargs
        )
        # self.model.cuda()
